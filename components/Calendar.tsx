...
export default function Calendar({ selectedDate, onDateSelect, highlightedDates = [] }: CalendarProps) {
        ...
        days.push(
          <button
            ...
            className={`
              ...
              ${isTodayDate && !isSelected ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : ''}
              ${isHighlighted && !isSelected ? 'ring-2 ring-green-500' : ''}
            `}
          >
            {format(day, 'd')}
